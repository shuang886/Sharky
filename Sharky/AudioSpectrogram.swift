...
//  https://github.com/keefo/NeewerLite/blob/main/NeewerLite/NeewerLite/Spectrogram/AudioSpectrogram.swift
//
...
public class AudioSpectrogram: NSObject {
    ...
    let logger = Logger(subsystem: "NeeweerLite", category: "AudioSpectrogram")
        ...
        switch AVCaptureDevice.authorizationStatus(for: .audio) {
            ...
            case .notDetermined:
                ...
                AVCaptureDevice.requestAccess(for: .audio,
                    ...
                    if !granted {
                        self.logger.error("App requires microphone access.")
                    } else {
